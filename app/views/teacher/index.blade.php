...
@section('content')
  ...
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page">อาจารย์</li>
  </ol>
  </nav>
<br>

  @include('layouts.alert')
<h3>อาจารย์ทั้งหมด <small class="pull-right">

        @if(Auth::user()->roleID == 2)
    <a href="{{ url($route.'create') }}" class="btn btn-sm btn-default">เพิ่มอาจารย์ +</a></small>
@endif
</h3>
<form>
