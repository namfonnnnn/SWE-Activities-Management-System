...
@section('content')
    ...
    <ol class="breadcrumb">
      <li class="breadcrumb-item"><a href="{{url('/')}}">หน้าแรก</a></li>
        <li class="breadcrumb-item"><a href="{{url($route)}}">อาจารย์</a></li>
      <li class="breadcrumb-item active" aria-current="page">เพิ่ม & แก้ไขข้อมูลอาจารย์</li>
    </ol>
    </nav>
  <br>
    ...
    <div class="col-sm-12">
        <div class="row">
            ...
            {{--  FORM --}}
            <div class="col-md-12">
                <h3>เพิ่ม & แก้ไขข้อมูลอาจารย์</h3>
