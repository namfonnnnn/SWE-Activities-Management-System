  ...
  <div id="wrapper">
    ...
    <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="{{ url ('') }}">SB Admin v2.0 | Laravel 4.2</a>
      </div>
      <!-- /.navbar-header -->
          ...
          <ul class="nav" id="side-menu">
            ...
            @if(Auth::check())
              <li {{ (Request::is('/') ? 'class="active"' : '') }}>
                <a href="{{ url ('') }}"><i class="fa fa-dashboard fa-fw"></i> Dashboard Student</a>
              </li>
              <li {{ (Request::is('*upload') ? 'class="active"' : '') }}>
                <a href="{{ url ('upload') }}"><i class="fa fa-dashboard fa-fw"></i> Dashboard Teacher</a>
              </li>
              <li {{ (Request::is('*admin') ? 'class="active"' : '') }}>
                <a href="{{ url ('admin') }}"><i class="fa fa-dashboard fa-fw"></i> Dashboard Admin</a>
              </li>
            ...
            <li>
              <a href="#"><i class="fa fa-files-o fa-fw"></i> Activity Pages<span class="fa arrow"></span></a>
              <ul class="nav nav-second-level">
                <li {{ (Request::is('*blank') ? 'class="active"' : '') }}>
                  <a href="{{ url ('blank') }}">Blank Page</a>
                </li>
                <li>
                  <a href="{{ url ('createactivity') }}">สร้างกิจกรรม</a>
                </li>
              </ul>
              <!-- /.nav-second-level -->
            </li>
