...
@section('content')
    ...
    <ol class="breadcrumb">
      <li class="breadcrumb-item"><a href="{{url('/')}}">หน้าแรก</a></li>
        <li class="breadcrumb-item"><a href="{{url($route)}}">ประธานหลักสูตร</a></li>
      <li class="breadcrumb-item active" aria-current="page">เพิ่ม & แก้ไขข้อมูลประธานหลักสูตร</li>
    </ol>
    </nav>
  <br>
    ...
    <div class="col-sm-12">
        <div class="row">
            ...
            {{--  FORM --}}
            <div class="col-md-12">
                <h3>เพิ่ม & แก้ไขข้อมูลประธานหลักสูตร</h3>
                        ...
                        <div class="form-group  {{$errors->has('file') ? 'has-error' : ''}}">
                            ...
                            <div class="cols-sm-10">
                                <div class="input-group">
                                    ...
                                    <input type="file" class="form-control" name="image" id="file"  placeholder=""   value="{{Request::old('tel', @$item->tel)}}"/>
                                </div>
                                @if(!empty(@$item->image))
