...
@section('content')
  ...
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page">ผู้ดูแลระบบ</li>
  </ol>
  </nav>
<br>

  @include('layouts.alert')
<h3>ผู้ดูแลระบบทั้งหมด <small class="pull-right">

        @if(Auth::user()->roleID == 2)
            <a href="{{ url($route.'create') }}" class="btn btn-sm btn-default">เพิ่มผู้ดูแลระบบ +</a></small>
        @endif
</h3>
<form>
